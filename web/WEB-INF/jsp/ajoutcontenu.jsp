...
<html>
    ...
    <body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <form style="margin-top: 100px;" action="<%=request.getContextPath()%>/addArticleContenu" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="ckeditor form-control" id="titre" name="titre" cols="50" rows="5"></textarea>
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea class="ckeditor form-control" id="description" name="description" cols="50" rows="5"></textarea>
