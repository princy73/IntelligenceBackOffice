...
<html>
    ...
    <%
        List<Article_Contenu> la = (List<Article_Contenu>) request.getAttribute("listArticle");
    %>
                ...
                <div class="row">
                    <div class="portfolio-item">
                        <div class="portfolio-caption">
                            <%= la.get(i).getTitre()%>
                            <a class="btn btn-primary btn-xl text-uppercase" role="button" href="<%=request.getContextPath()%>/article/<%= la.get(i).getId()%>" style="height: 60px;width: 151.9px;">voir</a>
                        </div>
                    </div>
                </div>
            </div>
